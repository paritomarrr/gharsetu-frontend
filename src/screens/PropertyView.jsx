  ...
  useEffect(() => {
    const fetchPropertiesBySearch = async (searchTerms) => {
      ...
      try {
        ...
        const res = await axios.post('https://gharsetu-server.vercel.app/api/v1/properties/filteredProperties', {
          locality,
          city,
          state,
          mode,
    ...
    const fetchAllProperties = async () => {
      try {
        const res = await axios.post(
          "https://gharsetu-server.vercel.app/api/v1/properties/getAllProperties",
          {
            mode,
